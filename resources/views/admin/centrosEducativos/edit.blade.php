...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.centrosEducativo.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.centros-educativos.update", [$centrosEducativo->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="codcompany">{{ trans('cruds.centrosEducativo.fields.codcompany') }}</label>
                <input class="form-control {{ $errors->has('codcompany') ? 'is-invalid' : '' }}" type="text" name="codcompany" id="codcompany" value="{{ old('codcompany', $centrosEducativo->codcompany) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ciudad') ? 'is-invalid' : '' }}" name="ciudad_id" id="ciudad_id" required>
                    @foreach($ciudads as $id => $ciudad)
                        <option value="{{ $id }}" {{ ($centrosEducativo->ciudad ? $centrosEducativo->ciudad->id : old('ciudad_id')) == $id ? 'selected' : '' }}>{{ $ciudad }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('territorio_veci') ? 'is-invalid' : '' }}" name="territorio_veci_id" id="territorio_veci_id" required>
                    @foreach($territorio_vecis as $id => $territorio_veci)
                        <option value="{{ $id }}" {{ ($centrosEducativo->territorio_veci ? $centrosEducativo->territorio_veci->id : old('territorio_veci_id')) == $id ? 'selected' : '' }}>{{ $territorio_veci }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('turno') ? 'is-invalid' : '' }}" name="turno" id="turno">
                    ...
                    @foreach(App\CentrosEducativo::TURNO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('turno', $centrosEducativo->turno) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('turno'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_index') ? 'is-invalid' : '' }}" type="text" name="date_index" id="date_index" value="{{ old('date_index', $centrosEducativo->date_index) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('categories_items') ? 'is-invalid' : '' }}" name="categories_items_id" id="categories_items_id" required>
                    @foreach($categories_items as $id => $categories_items)
                        <option value="{{ $id }}" {{ ($centrosEducativo->categories_items ? $centrosEducativo->categories_items->id : old('categories_items_id')) == $id ? 'selected' : '' }}>{{ $categories_items }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('categories_types') ? 'is-invalid' : '' }}" name="categories_types_id" id="categories_types_id" required>
                    @foreach($categories_types as $id => $categories_types)
                        <option value="{{ $id }}" {{ ($centrosEducativo->categories_types ? $centrosEducativo->categories_types->id : old('categories_types_id')) == $id ? 'selected' : '' }}>{{ $categories_types }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\CentrosEducativo::CATEGORY_EMPRESA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('category_empresa') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="category_empresa_{{ $key }}" name="category_empresa" value="{{ $key }}" {{ old('category_empresa', $centrosEducativo->category_empresa) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_company') ? 'is-invalid' : '' }}" type="text" name="name_company" id="name_company" value="{{ old('name_company', $centrosEducativo->name_company) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $centrosEducativo->address) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('reference') ? 'is-invalid' : '' }}" name="reference" id="reference">{{ old('reference', $centrosEducativo->reference) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_float') ? 'is-invalid' : '' }}" type="number" name="num_float" id="num_float" value="{{ old('num_float', $centrosEducativo->num_float) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('float_company') ? 'is-invalid' : '' }}" type="number" name="float_company" id="float_company" value="{{ old('float_company', $centrosEducativo->float_company) }}" step="0.1" min="1" max="50">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('caracteristicas') ? 'is-invalid' : '' }}" name="caracteristicas" id="caracteristicas">
                    ...
                    @foreach(App\CentrosEducativo::CARACTERISTICAS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('caracteristicas', $centrosEducativo->caracteristicas) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('uso_local') ? 'is-invalid' : '' }}" name="uso_local" id="uso_local">
                    ...
                    @foreach(App\CentrosEducativo::USO_LOCAL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('uso_local', $centrosEducativo->uso_local) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('material') ? 'is-invalid' : '' }}" name="material" id="material">
                    ...
                    @foreach(App\CentrosEducativo::MATERIAL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('material', $centrosEducativo->material) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipoempresa') ? 'is-invalid' : '' }}" name="tipoempresa" id="tipoempresa">
                    ...
                    @foreach(App\CentrosEducativo::TIPOEMPRESA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipoempresa', $centrosEducativo->tipoempresa) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="number" name="latitude" id="latitude" value="{{ old('latitude', $centrosEducativo->latitude) }}" step="0.00000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="number" name="longitude" id="longitude" value="{{ old('longitude', $centrosEducativo->longitude) }}" step="0.00000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_google_map') ? 'is-invalid' : '' }}" type="text" name="link_google_map" id="link_google_map" value="{{ old('link_google_map', $centrosEducativo->link_google_map) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $centrosEducativo->active || old('active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $centrosEducativo->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $centrosEducativo->website) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $centrosEducativo->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $centrosEducativo->telefono) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono_2') ? 'is-invalid' : '' }}" type="text" name="telefono_2" id="telefono_2" value="{{ old('telefono_2', $centrosEducativo->telefono_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('encargado') ? 'is-invalid' : '' }}" type="text" name="encargado" id="encargado" value="{{ old('encargado', $centrosEducativo->encargado) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('nivel') ? 'is-invalid' : '' }}" name="nivel" id="nivel">
                    ...
                    @foreach(App\CentrosEducativo::NIVEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('nivel', $centrosEducativo->nivel) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('nivel'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gestion') ? 'is-invalid' : '' }}" name="gestion" id="gestion">
                    ...
                    @foreach(App\CentrosEducativo::GESTION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gestion', $centrosEducativo->gestion) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('supervisa') ? 'is-invalid' : '' }}" name="supervisa" id="supervisa">
                    ...
                    @foreach(App\CentrosEducativo::SUPERVISA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('supervisa', $centrosEducativo->supervisa) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cant_alumnos') ? 'is-invalid' : '' }}" type="number" name="cant_alumnos" id="cant_alumnos" value="{{ old('cant_alumnos', $centrosEducativo->cant_alumnos) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cant_docentes') ? 'is-invalid' : '' }}" type="number" name="cant_docentes" id="cant_docentes" value="{{ old('cant_docentes', $centrosEducativo->cant_docentes) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cant_secciones') ? 'is-invalid' : '' }}" type="number" name="cant_secciones" id="cant_secciones" value="{{ old('cant_secciones', $centrosEducativo->cant_secciones) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('departamento') ? 'is-invalid' : '' }}" name="departamento_id" id="departamento_id">
                    @foreach($departamentos as $id => $departamento)
                        <option value="{{ $id }}" {{ ($centrosEducativo->departamento ? $centrosEducativo->departamento->id : old('departamento_id')) == $id ? 'selected' : '' }}>{{ $departamento }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('provincia') ? 'is-invalid' : '' }}" name="provincia_id" id="provincia_id">
                    @foreach($provincias as $id => $provincia)
                        <option value="{{ $id }}" {{ ($centrosEducativo->provincia ? $centrosEducativo->provincia->id : old('provincia_id')) == $id ? 'selected' : '' }}>{{ $provincia }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('distrito') ? 'is-invalid' : '' }}" name="distrito_id" id="distrito_id">
                    @foreach($distritos as $id => $distrito)
                        <option value="{{ $id }}" {{ ($centrosEducativo->distrito ? $centrosEducativo->distrito->id : old('distrito_id')) == $id ? 'selected' : '' }}>{{ $distrito }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cod_zip') ? 'is-invalid' : '' }}" type="text" name="cod_zip" id="cod_zip" value="{{ old('cod_zip', $centrosEducativo->cod_zip) }}">
